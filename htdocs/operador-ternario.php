...
<body>
    ...
    <p> Possui cartão da loja? <?= $usuario_possui_cartao_loja == true ? "SIM":"NÂO";  ?>

    <?php  // operador ternario // <condicao> ? true: false; ?>
    </p>
    ...
    <p> Recebeu desconto no frete? <?= $recebeu_desconto_frete == true ? "SIM":"NÂO"; ?> </p>
